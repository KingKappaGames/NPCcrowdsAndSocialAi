function script_createSpeechBubble(xx, yy, messageText, durationSet, createDelay, textSpeed, posCurve, sizeCurve, arrowOriginX = x, arrowOriginY = y - (sprite_height / 2) - 25, multipleChoiceSet = false, optionsChosenArraySet = -1, optionsCriteriaArraySet = -1){
