function script_createSpeechBubble(xx, yy, messageText, durationSet, createDelay, textSpeed, posCurve, sizeCurve, arrowOriginX = x, arrowOriginY = y - (sprite_height / 2) - 25){
	...
	_bubble.setState(messageText, posCurve, sizeCurve, xx - arrowOriginX, yy - arrowOriginY, createDelay, textSpeed);
