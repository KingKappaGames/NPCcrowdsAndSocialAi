function script_createWaterProjectile(xx, yy, heightSet = 1, sizeSet = undefined, hspeedSet = random_range(0, 2), vspeedSet = random_range(0, 2), heightChangeSet = random_range(.5, 4), gravitySet = .07, blend = c_white, alpha = 1, makeChildrenSet = true) {
	...
	_proj.size = sizeSet;
	_proj.hspeed = hspeedSet;
	_proj.vspeed = vspeedSet;
