function script_generateSelfComment() {
	...
	if(_time == "morning" && irandom(4) == 0) {
		...
		return ["[wave]The [#ffbbbb]lord[#ffffff] lies deep, the lands grow [#aaaa00]rich[#ffffff] and [#aaaa00]toiled[#ffffff]...[/wave]", "My hands are worn, the valley's man, I am a proud lands soul. Good day visitor.", "Hm. It's only a saying.", "Is there a problem?", "Hm? It's an old verse, you've never heard?", "Aye, common man we are"];
	} else {
