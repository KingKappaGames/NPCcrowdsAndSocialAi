function script_generateSelfComment() {
	...
	if(_time == "morning" && irandom(4) == 0) {
		...
		return ["The lord lies deep, the lands grow rich and toiled...", "My hands are worn, the valley's man, I am a proud lands soul. Good day visitor.", "Hm. It's only a saying.", "Is there a problem?", "Hm? It's an old verse, you've never heard?", "Aye, common man we are"];
	} else {
