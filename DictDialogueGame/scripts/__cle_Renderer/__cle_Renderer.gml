...
function Crystal_Renderer() constructor {
	...
	static Render = function(_surface, _camera) {
		...
		if (__isRenderEnabled) {
			...
			if (_inputSurfaceWidth != __renderSurfaceOldWidth || _inputSurfaceHeight != __renderSurfaceOldHeight) {
				__cleanSurfaces();
				...
				__renderSurfaceOldWidth = _inputSurfaceWidth;
				__renderSurfaceOldHeight = _inputSurfaceHeight;
			}
