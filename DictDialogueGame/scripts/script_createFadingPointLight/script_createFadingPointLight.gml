function script_createFadingPointLight(xx, yy, depthSet, radiusSet, brightness, duration, colorSet = c_white, fadeCurve = curve_glowFade, castShadows = 1, shader = LIGHT_SHADER_BRDF) {
